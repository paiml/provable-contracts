...
pub(super) fn generate_invariant_body(
    out: &mut String,
    ob: &ProofObligation,
) {
...
pub(super) fn generate_equivalence_body(
    out: &mut String,
    ob: &ProofObligation,
) {
    let tol = tolerance_str(ob);
...
pub(super) fn generate_bound_body(
    out: &mut String,
    ob: &ProofObligation,
) {
    out.push_str(
...
pub(super) fn generate_monotonicity_body(
    out: &mut String,
    ob: &ProofObligation,
) {
    out.push_str(
...
pub(super) fn generate_idempotency_body(
    out: &mut String,
    ob: &ProofObligation,
) {
    let tol = tolerance_str(ob);
...
pub(super) fn generate_linearity_body(
    out: &mut String,
    ob: &ProofObligation,
) {
    let tol = tolerance_str(ob);
...
pub(super) fn generate_symmetry_body(
    out: &mut String,
    ob: &ProofObligation,
) {
    out.push_str(
...
pub(super) fn generate_associativity_body(
    out: &mut String,
    ob: &ProofObligation,
) {
    let tol = tolerance_str(ob);
...
pub(super) fn generate_conservation_body(
    out: &mut String,
    ob: &ProofObligation,
) {
    let tol = tolerance_str(ob);
